...
public class GcmRefreshJob extends ContextJob implements InjectableType {
  ...
  public void onRun() throws Exception {
    ...
    if (registrationId == null) {
      ...
      if ((result != ConnectionResult.SUCCESS && !(android.os.Build.BRAND.toLowerCase().contains("blackberry") && result == ConnectionResult.SERVICE_INVALID)) || TextSecurePreferences.isForceWebsocketEnabled(context)) {
        notifyGcmFailure();
      } else {
